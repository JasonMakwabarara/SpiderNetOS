...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('memory_nodes', function (Blueprint $table) use ($isPgsql) {
            ...
            if ($isPgsql) {
                ...
                // sqlite (tests): pgvector unavailable — store the raw vector
                // as JSON so schema-dependent code still runs. Similarity
                // search is a Postgres-only capability.
