...
final class PropertyRegistry
{
    ...
    private const CATALOGUE = [
        ...
        'steps_count' => ['arg' => PropertyArg::Int, 'handler' => 'checkStepsCount',
        ...
        'subjects_per_step' => ['arg' => PropertyArg::Int, 'handler' => 'checkSubjectsPerStep',
            'summary' => 'Every step carries exactly N subjects.'],
        'single_cta_per_step' => ['arg' => PropertyArg::None, 'handler' => 'checkSingleCtaPerStep',
        ...
        'classification' => ['arg' => PropertyArg::Selector, 'collapses_into' => 'field',
            'summary' => 'items[message_id=<id>].classification equals <value>.'],
        'draft_action' => ['arg' => PropertyArg::Selector, 'collapses_into' => 'field',
            'summary' => 'items[message_id=<id>].draft_action equals <value>.'],
        'draft_action_in' => ['arg' => PropertyArg::SelectorCsv, 'collapses_into' => 'enum',
            'summary' => 'items[message_id=<id>].draft_action is one of <a,b>.'],
        'draft_reply_null' => ['arg' => PropertyArg::SelectorOnly, 'collapses_into' => 'is_null',
            'summary' => 'items[message_id=<id>].draft_reply is null. Absent and null are different states.'],
        'angle' => ['arg' => PropertyArg::Selector, 'collapses_into' => 'field',
            'summary' => 'items[thread_id=<id>].angle equals <value>.'],
        'angle_in' => ['arg' => PropertyArg::SelectorCsv, 'collapses_into' => 'enum',
            'summary' => 'items[thread_id=<id>].angle is one of <a,b>.'],
        'is_close_out' => ['arg' => PropertyArg::Selector, 'collapses_into' => 'field',
        ...
        // --- how many ---
        'items_count' => ['arg' => PropertyArg::Int, 'collapses_into' => 'count',
            'summary' => 'items[] has exactly <n> elements. Zero is a legitimate answer for a batch skill.'],
        'messages_count' => ['arg' => PropertyArg::Int, 'collapses_into' => 'count',
            'summary' => 'messages[] has exactly <n> elements.'],
        'slots_count' => ['arg' => PropertyArg::IntOrSelector, 'collapses_into' => 'count',
            'summary' => 'slots[] has <n> elements — at the root, or inside the item named by a selector.'],
        'angles_min' => ['arg' => PropertyArg::Int, 'collapses_into' => 'count',
            'summary' => 'angles[] has at least <n> elements.'],
        'blocks_between' => ['arg' => PropertyArg::Range, 'collapses_into' => 'count',
            'summary' => 'blocks[] has between <low> and <high> elements.'],
        'segments_count_between' => ['arg' => PropertyArg::Range, 'collapses_into' => 'count',
            'summary' => 'segments[] has between <low> and <high> elements.'],
        'personalisation_lines_count' => ['arg' => PropertyArg::Int, 'collapses_into' => 'count',
            'summary' => 'personalisation_lines[] has exactly <n> elements.'],
        'frontmatter_tone_count_between' => ['arg' => PropertyArg::Range, 'collapses_into' => 'count',
            'summary' => 'frontmatter.tone[] has between <low> and <high> entries.'],
        'subject_variants' => ['arg' => PropertyArg::Int, 'collapses_into' => 'count',
        ...
        'no_cta_block' => ['arg' => PropertyArg::None, 'collapses_into' => 'set_excludes',
            'summary' => 'No block has role cta.'],
        'proof_has_source' => ['arg' => PropertyArg::None, 'collapses_into' => 'not_empty',
        ...
        'single_ask_per_message' => ['arg' => PropertyArg::None, 'collapses_into' => 'domain',
            'summary' => 'Each message makes one ask — natural-language question counting, not a regex.'],
        'slots_within_hours' => ['arg' => PropertyArg::TimeRange, 'collapses_into' => 'domain',
        ...
        'every_angle_has_source' => ['arg' => PropertyArg::None, 'collapses_into' => 'domain',
        ...
        'sources_subset_of_fixture' => ['arg' => PropertyArg::None, 'collapses_into' => 'domain',
