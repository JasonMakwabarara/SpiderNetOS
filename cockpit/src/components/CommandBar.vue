...
const ROUTES = [
  ...
  { id: 'r-bills',      label: 'Bill pay',            hint: 'AP inbox',                path: '/financial/bills' },
  { id: 'r-vendors',    label: 'Vendors',             hint: 'Supplier directory',      path: '/financial/vendors' },
  { id: 'r-spend-analytics', label: 'Spend analytics', hint: 'Trends & budgets',       path: '/financial/spend' },
  { id: 'r-accounting', label: 'Accounting',          hint: 'GL mappings & postings',  path: '/financial/accounting' },
  { id: 'r-export-center', label: 'Export center',    hint: 'QuickBooks / Xero / CSV', path: '/financial/accounting/export' },
